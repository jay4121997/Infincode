...
const Hero = () => (
    <section className="h-dvh bg-gradient flex flex-col">
    <div className="h-1/6"> 
      <Lottie animationData={ani} loop={true}  className="opacity-15 "/>
    </div>
    <div className="flex-1 flex items-top justify-center md:items-center text-gray-600"> 
      <div className="space-y-5 max-w-4xl mx-auto text-center content">
